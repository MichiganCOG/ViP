...
class Parse():
    ...
    def __init__(self):
        ...
        parser.add_argument('--resize_shape', nargs=2, type=int,  help='(Height, Width) to resize original data')
        parser.add_argument('--final_shape',  nargs=2,  type=int, help='(Height, Width) of input to be given to CNN')
        ...
        parser.add_argument('--crop_shape',   nargs=2,  type=int, help='(Height, Width) of frame') 
